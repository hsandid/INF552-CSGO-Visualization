...
var startStop = function(){
  ...
  ctx.playerCoordinatesTeam2Dead = [];
    ...
    let playerPosDataTeam1Dead = d3.select("#team1dead").selectAll("path").data(ctx.playerCoordinatesTeam1Dead, (d) => (d.name));
    
    playerPosDataTeam1Dead.exit().remove();

    let playerPosDataTeam2Dead = d3.select("#team2dead").selectAll("path").data(ctx.playerCoordinatesTeam2Dead, (d) => (d.name));
...
function representPlayers(playerCoordinatesTeam1Alive, playerCoordinatesTeam2Alive,  playerCoordinatesTeam1Dead,  playerCoordinatesTeam2Dead)
{
  ...
  // Live Players
  let playerPosDataTeam1 = d3.select("#team1alive").selectAll("path").data(playerCoordinatesTeam1Alive, (d) => (d.name));
  ...
  let playerPosDataTeam2 = d3.select("#team2alive").selectAll("path").data(playerCoordinatesTeam2Alive, (d) => (d.name));
